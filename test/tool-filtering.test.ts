...
describe('Tool Filtering', () => {
  ...
  it('should register all tools when no filter is provided', () => {
    ...
    // 5 mocked endpoints + parse-teams-url + download-bytes + save-attachment-to-onedrive utility tools
  ...
  it('should handle invalid regex patterns gracefully', () => {
    ...
    // 5 mocked endpoints + parse-teams-url + download-bytes + save-attachment-to-onedrive (no filter applied on invalid regex)
    expect(toolSpy).toHaveBeenCalledTimes(8);
  });
